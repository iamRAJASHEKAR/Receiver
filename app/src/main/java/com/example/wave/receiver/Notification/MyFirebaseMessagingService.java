package com.example.wave.receiver.Notification;
...
import com.example.wave.receiver.Activities.MyUploadsController;
...

    {
        if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
            if (message.contains("Device Unpaired")) {
                ...
                Intent pushNotification_logout = new Intent(Config.PUSH_NOTIFICATIONLOGOUT);
                ...
                Intent pushNotification_file = new Intent(Config.PUSH_NOTIFICATION_DATA);
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), SerialNumber.class);
